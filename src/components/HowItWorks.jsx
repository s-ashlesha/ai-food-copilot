  ...
  const steps = [
    {
      ...
      title: 'Scan or Type',
      description: 'Photo or text. We support both.'
    },
    {
      number: '02',
      icon: (
      ...
      title: 'AI Analysis',
      description: 'Instant identification and explanation.'
    },
    {
      number: '03',
      icon: (
      ...
      title: 'Understand',
      description: 'Clear details with confidence scores.'
    },
    {
      number: '04',
      icon: (
      ...
      title: 'Decide',
      description: 'Make informed food choices easily.'
    }
  ];
